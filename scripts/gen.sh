...
$CMAKE -G Ninja .. -DMLIR_DIR=$LLVM_DIR/$MLIR_BUILD/lib/cmake/mlir -DLLVM_EXTERNAL_LIT=$LLVM_DIR/$MLIR_BUILD/llvm-lit -DCMAKE_BUILD_TYPE=Debug -DCMAKE_POLICY_DEFAULT_CMP0116=OLD
