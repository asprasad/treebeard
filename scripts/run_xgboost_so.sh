...
RUN_CMD="$TREEBEARD_EXEC --loadSO $SPARSE_FLAG -json $MODEL_JSON -globalValuesJSON $MODEL_GLOBALS_JSON -so $SO_FILE -batchSize $BATCH_SIZE -tileSize $TILE_SIZE -i $INPUT_FILE"
echo "$RUN_CMD"
$RUN_CMD
