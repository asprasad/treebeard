...
#define COMPILER_OPTION_SETTER_DECLARATION(propName, propType)                 \
  TREEBEARD_RUNTIME_EXPORT void Set_##propName(intptr_t options, propType val);

extern "C" {
TREEBEARD_RUNTIME_EXPORT void RunInference(intptr_t inferenceRunnerInt,
                                           void *inputs, void *results);

TREEBEARD_RUNTIME_EXPORT void
DeleteInferenceRunner(intptr_t inferenceRunnerInt);
...
TREEBEARD_RUNTIME_EXPORT void
SetPeeledCodeGenForProbabilityBasedTiling(int32_t val);
TREEBEARD_RUNTIME_EXPORT int32_t
IsPeeledCodeGenForProbabilityBasedTilingEnabled();
TREEBEARD_RUNTIME_EXPORT void SetEnableMeasureGpuKernelTime(bool val);
TREEBEARD_RUNTIME_EXPORT void SetNumberOfKernelRuns(int32_t val);

TREEBEARD_RUNTIME_EXPORT intptr_t
CreateInferenceRunnerForONNXModel(const char *modelPath, intptr_t options);
}
