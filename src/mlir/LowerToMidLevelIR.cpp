...
struct PredictForestOpLowering: public ConversionPattern {
                            ...
                            mlir::MemRefType dataMemrefType, int64_t batchSize) const
  {
        ...
        // Create the 'do' part for the condition.
        {
            ...
            auto equalTo = rewriter.create<arith::CmpIOp>(location, mlir::arith::CmpIPredicate::eq, static_cast<Value>(isLeaf), static_cast<Value>(falseConstant));
        ...
        auto accumulatedValue = rewriter.create<arith::AddFOp>(location, resultElementType, treeLoop.getBody()->getArguments()[1], treePrediction);
