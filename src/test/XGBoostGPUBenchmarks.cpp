...
public:
  ...
  void exploreSchedules() {
    ...
    // TODO now check if we need to do a shared reduction.
...
void RunXGBoostGPUBenchmarks() {
  ...
  findBestGPUSchedule("abalone", 1024);
}
