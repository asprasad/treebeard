...
//   TEST_LIST_ENTRY(Test_TiledCodeGeneration_LeftAndRightHeavy_BatchSize1_Int16TileSize),
  TEST_LIST_ENTRY(Test_RandomXGBoostJSONs_1Tree_BatchSize1_Pipelined_Vector),
  TEST_LIST_ENTRY(Test_RandomXGBoostJSONs_4Trees_BatchSize4_Pipelined_Vector),
  TEST_LIST_ENTRY(Test_RandomXGBoostJSONs_1Tree_BatchSize1_NotPipelined_Vector),
#ifndef OMP_SUPPORT
  ...
  TEST_LIST_ENTRY(Test_SparseTileSize8_Pipelined_Bosch),
  ...
  TEST_LIST_ENTRY(Test_TileSize8_Abalone_Pipelined_TestInputs),
  ...
  TEST_LIST_ENTRY(Test_TileSize8_CovType_Pipelined_TestInputs),
