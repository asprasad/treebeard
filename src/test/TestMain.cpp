...
TestDescriptor gpuTestList[] = {
    ...
    */
    ...
    // TEST_LIST_ENTRY(
    // Test_GPU_iterativeCachedPartialForestStrategy_4TreeXGB_Sparse_Tile4),
    //  TEST_LIST_ENTRY(Test_GPU_iterativeCachedPartialForestStrategy_4TreeXGB_Reorg_Scalar),
    ...
    TEST_LIST_ENTRY(Test_GPU_TahoeSharedDataStrategy_2TreeXGB_Reorg_Scalar_f32i16),
    TEST_LIST_ENTRY(Test_GPU_TahoeSharedDataStrategy_4TreeXGB_Reorg_Scalar_f32i16),
    TEST_LIST_ENTRY(Test_GPU_iterativeCachedPartialForestStrategy_4TreeXGB_Reorg_Scalar_f32i16),
    // TEST_LIST_ENTRY(Test_GPU_iterativeCachedPartialForestStrategy_4TreeXGB_Array_Scalar_f32i16),
    // TEST_LIST_ENTRY(Test_GPU_iterativeCachedPartialForestStrategy_4TreeXGB_Sparse_Scalar_f32i16),
    //  TEST_LIST_ENTRY(Test_GPU_iterativeCachedPartialForestStrategy_4TreeXGB_Sparse_Tile4_f32i16),

    // TEST_LIST_ENTRY(Test_ScalarSparseGPU_TwiceLeftRightBalanced_AutoScheduleCachedRows),
    // TEST_LIST_ENTRY(Test_ScalarSparseGPU_TwiceLeftRightBalanced_AutoScheduleBasic),
    ...
    TEST_LIST_ENTRY(
    Test_GPU_TahoeSharedDataStrategy_2TreeXGB_Sparse_Scalar_f32i16),
    TEST_LIST_ENTRY(Test_GPU_TahoeSharedDataStrategy_4TreeXGB_Sparse_Scalar_f32i16),
    TEST_LIST_ENTRY(Test_GPU_TahoeSharedDataStrategy_2TreeXGB_Array_Scalar_f32i16),
    TEST_LIST_ENTRY(Test_GPU_TahoeSharedDataStrategy_4TreeXGB_Array_Scalar_f32i16),
    TEST_LIST_ENTRY(Test_ScalarSparseGPU_TwiceLeftRightBalanced_iterCachedPartialForest_NoCache_SpecializedTreeLoop_FltI16_B64),
    TEST_LIST_ENTRY(
        Test_GPUCodeGeneration_Covtype_SparseRep_f32i16_B32_iterativeCachedPartialForestStrategy_NoCache),
    TEST_LIST_ENTRY(Test_ScalarSparseGPU_TwiceLeftRightBalanced_AutoScheduleCachedTrees),
