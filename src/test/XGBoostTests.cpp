...
bool Test_CodeGenForJSON_VariableBatchSize(
  ...
  TreeBeard::TreebeardContext tbContext(
      modelJsonPath, modelGlobalsJSONFilePath, options,
  ...
  auto module = TreeBeard::ConstructLLVMDialectModuleFromXGBoostJSON<
      FloatType, ResultType, FeatureIndexType>(tbContext);

  decisionforest::InferenceRunner inferenceRunner(
      tbContext.serializer, module, tileSize, sizeof(FloatType) * 8,
...
bool Test_RandomXGBoostJSONs_VariableTrees_VariableBatchSize(
  ...
  while (!fin.eof()) {
    ...
    Test_ASSERT(Test_CodeGenForJSON_VariableBatchSize<FloatType>(
        ...
        tileShapeBitWidth, childIndexBitWidth, makeAllTreesSameDepth,
...
bool Test_RandomXGBoostJSONs_1Tree_VariableBatchSize(
    TestArgs_t &args, int32_t batchSize, int32_t tileSize = 1,
    int32_t tileShapeBitWidth = 32, int32_t childIndexBitWidth = 1,
    bool makeAllTreesSameDepth = false, bool reorderTrees = false,
    ScheduleManipulator_t scheduleManipulatorFunc = nullptr,
    int32_t pipelineSize = -1) {
  return Test_RandomXGBoostJSONs_VariableTrees_VariableBatchSize<FloatType>(
...
template <typename FloatType = double>
bool Test_RandomXGBoostJSONs_2Trees_VariableBatchSize(
    TestArgs_t &args, int32_t batchSize, int32_t tileSize = 1,
    int32_t tileShapeBitWidth = 32, int32_t childIndexBitWidth = 1,
    bool makeAllTreesSameDepth = false, bool reorderTrees = false) {
  return Test_RandomXGBoostJSONs_VariableTrees_VariableBatchSize<FloatType>(
...
template <typename FloatType = double>
bool Test_RandomXGBoostJSONs_4Trees_VariableBatchSize(
    TestArgs_t &args, int32_t batchSize, int32_t tileSize = 1,
    int32_t tileShapeBitWidth = 32, int32_t childIndexBitWidth = 1,
    bool makeAllTreesSameDepth = false, bool reorderTrees = false,
    ScheduleManipulator_t scheduleManipulatorFunc = nullptr,
...
bool Test_RandomXGBoostJSONs_1Tree_BatchSize8_TileSize2_4Pipelined(
    TestArgs_t &args) {
  return Test_RandomXGBoostJSONs_1Tree_VariableBatchSize(
      args, 8, 2, 32, 2, true, true, nullptr, 4);
}

bool Test_RandomXGBoostJSONs_1Tree_BatchSize8_TileSize4_4Pipelined(
    TestArgs_t &args) {
  return Test_RandomXGBoostJSONs_1Tree_VariableBatchSize(
      args, 8, 4, 32, 3, true, true, nullptr, 4);
}

bool Test_RandomXGBoostJSONs_4Trees_BatchSize4_4Pipelined(TestArgs_t &args) {
  return Test_RandomXGBoostJSONs_4Trees_VariableBatchSize(
      args, 8, 4, 32, 3, true, true, nullptr, 4);
}
...
bool Test_Sparse_RandomXGBoostJSONs_1Tree_BatchSize1_Float(TestArgs_t &args) {
  if (RunSingleBatchSizeForXGBoostTests)
    return true;
  decisionforest::UseSparseTreeRepresentation = true;
  return Test_RandomXGBoostJSONs_1Tree_VariableBatchSize<float>(args, 1, 1, 32,
                                                                32);
}
...
bool Test_Sparse_RandomXGBoostJSONs_1Tree_BatchSize2_Float(TestArgs_t &args) {
  if (RunSingleBatchSizeForXGBoostTests)
    return true;
  decisionforest::UseSparseTreeRepresentation = true;
  return Test_RandomXGBoostJSONs_1Tree_VariableBatchSize<float>(args, 2, 1, 32,
                                                                32);
}

bool Test_Sparse_RandomXGBoostJSONs_1Tree_BatchSize4_Float(TestArgs_t &args) {
  decisionforest::UseSparseTreeRepresentation = true;
  return Test_RandomXGBoostJSONs_1Tree_VariableBatchSize<float>(args, 4, 1, 32,
                                                                32);
}
...
bool Test_Sparse_RandomXGBoostJSONs_2Trees_BatchSize1_Float(TestArgs_t &args) {
  if (RunSingleBatchSizeForXGBoostTests)
    return true;
  decisionforest::UseSparseTreeRepresentation = true;
  return Test_RandomXGBoostJSONs_2Trees_VariableBatchSize<float>(args, 1, 1, 32,
                                                                 32);
}
...
bool Test_Sparse_RandomXGBoostJSONs_2Trees_BatchSize2_Float(TestArgs_t &args) {
  if (RunSingleBatchSizeForXGBoostTests)
    return true;
  decisionforest::UseSparseTreeRepresentation = true;
  return Test_RandomXGBoostJSONs_2Trees_VariableBatchSize<float>(args, 2, 1, 32,
                                                                 32);
}

bool Test_Sparse_RandomXGBoostJSONs_2Trees_BatchSize4_Float(TestArgs_t &args) {
  decisionforest::UseSparseTreeRepresentation = true;
  return Test_RandomXGBoostJSONs_2Trees_VariableBatchSize<float>(args, 4, 1, 32,
                                                                 32);
}
...
bool Test_Sparse_RandomXGBoostJSONs_4Trees_BatchSize1_Float(TestArgs_t &args) {
  if (RunSingleBatchSizeForXGBoostTests)
    return true;
  decisionforest::UseSparseTreeRepresentation = true;
  return Test_RandomXGBoostJSONs_4Trees_VariableBatchSize<float>(args, 1, 1, 32,
                                                                 32);
}
...
bool Test_Sparse_RandomXGBoostJSONs_4Trees_BatchSize2_Float(TestArgs_t &args) {
  if (RunSingleBatchSizeForXGBoostTests)
    return true;
  decisionforest::UseSparseTreeRepresentation = true;
  return Test_RandomXGBoostJSONs_4Trees_VariableBatchSize<float>(args, 2, 1, 32,
                                                                 32);
}

bool Test_Sparse_RandomXGBoostJSONs_4Trees_BatchSize4_Float(TestArgs_t &args) {
  decisionforest::UseSparseTreeRepresentation = true;
  return Test_RandomXGBoostJSONs_4Trees_VariableBatchSize<float>(args, 4, 1, 32,
                                                                 32);
}
...
bool Test_UniformTiling_RandomXGBoostJSONs_1Tree_BatchSize1(TestArgs_t &args) {
    ...
    return true;
  {
    using FPType = double;
    Test_ASSERT(
        (Test_RandomXGBoostJSONs_1Tree_VariableBatchSize<FPType>(args, 1, 2)));
    Test_ASSERT(
        (Test_RandomXGBoostJSONs_1Tree_VariableBatchSize<FPType>(args, 1, 3)));
    Test_ASSERT(
        (Test_RandomXGBoostJSONs_1Tree_VariableBatchSize<FPType>(args, 1, 4)));
  }
  {
    using FPType = float;
    Test_ASSERT(
...
bool Test_UniformTiling_RandomXGBoostJSONs_2Trees_BatchSize1(TestArgs_t &args) {
    ...
    return true;
  {
    using FPType = double;
    Test_ASSERT(
        (Test_RandomXGBoostJSONs_2Trees_VariableBatchSize<FPType>(args, 1, 2)));
    Test_ASSERT(
        (Test_RandomXGBoostJSONs_2Trees_VariableBatchSize<FPType>(args, 1, 3)));
    Test_ASSERT(
        (Test_RandomXGBoostJSONs_2Trees_VariableBatchSize<FPType>(args, 1, 4)));
  }
  {
    using FPType = float;
    Test_ASSERT(
...
bool Test_UniformTiling_RandomXGBoostJSONs_4Trees_BatchSize1(TestArgs_t &args) {
    ...
    return true;
  {
    using FPType = double;
    Test_ASSERT(
        (Test_RandomXGBoostJSONs_4Trees_VariableBatchSize<FPType>(args, 1, 2)));
    Test_ASSERT(
        (Test_RandomXGBoostJSONs_4Trees_VariableBatchSize<FPType>(args, 1, 3)));
    Test_ASSERT(
        (Test_RandomXGBoostJSONs_4Trees_VariableBatchSize<FPType>(args, 1, 4)));
  }
  {
    using FPType = float;
    Test_ASSERT(
...
bool Test_UniformTiling_RandomXGBoostJSONs_1Tree_BatchSize2(TestArgs_t &args) {
    ...
    return true;
  {
    using FPType = double;
    Test_ASSERT(
        (Test_RandomXGBoostJSONs_1Tree_VariableBatchSize<FPType>(args, 2, 2)));
    Test_ASSERT(
        (Test_RandomXGBoostJSONs_1Tree_VariableBatchSize<FPType>(args, 2, 3)));
    Test_ASSERT(
        (Test_RandomXGBoostJSONs_1Tree_VariableBatchSize<FPType>(args, 2, 4)));
  }
  {
    using FPType = float;
    Test_ASSERT(
...
bool Test_UniformTiling_RandomXGBoostJSONs_2Trees_BatchSize2(TestArgs_t &args) {
    ...
    return true;
  {
    using FPType = double;
    Test_ASSERT(
        (Test_RandomXGBoostJSONs_2Trees_VariableBatchSize<FPType>(args, 2, 2)));
    Test_ASSERT(
        (Test_RandomXGBoostJSONs_2Trees_VariableBatchSize<FPType>(args, 2, 3)));
    Test_ASSERT(
        (Test_RandomXGBoostJSONs_2Trees_VariableBatchSize<FPType>(args, 2, 4)));
  }
  {
    using FPType = float;
    Test_ASSERT(
...
bool Test_UniformTiling_RandomXGBoostJSONs_4Trees_BatchSize2(TestArgs_t &args) {
    ...
    return true;
  {
    using FPType = double;
    Test_ASSERT(
        (Test_RandomXGBoostJSONs_4Trees_VariableBatchSize<FPType>(args, 2, 2)));
    Test_ASSERT(
        (Test_RandomXGBoostJSONs_4Trees_VariableBatchSize<FPType>(args, 2, 3)));
    Test_ASSERT(
        (Test_RandomXGBoostJSONs_4Trees_VariableBatchSize<FPType>(args, 2, 4)));
  }
  {
    using FPType = float;
    Test_ASSERT(
...
bool Test_UniformTiling_RandomXGBoostJSONs_1Tree_BatchSize4(TestArgs_t &args) {
  {
    using FPType = double;
    Test_ASSERT(
        (Test_RandomXGBoostJSONs_1Tree_VariableBatchSize<FPType>(args, 4, 2)));
    Test_ASSERT(
        (Test_RandomXGBoostJSONs_1Tree_VariableBatchSize<FPType>(args, 4, 3)));
    Test_ASSERT(
        (Test_RandomXGBoostJSONs_1Tree_VariableBatchSize<FPType>(args, 4, 4)));
  }
  {
    using FPType = float;
    Test_ASSERT(
...
bool Test_UniformTiling_RandomXGBoostJSONs_1Tree_BatchSize4_Int8TileShape(
  ...
  {
    using FPType = double;
    Test_ASSERT((Test_RandomXGBoostJSONs_1Tree_VariableBatchSize<FPType>(
        args, 4, 2, tileShapeBitWidth)));
    Test_ASSERT((Test_RandomXGBoostJSONs_1Tree_VariableBatchSize<FPType>(
        args, 4, 3, tileShapeBitWidth)));
    Test_ASSERT((Test_RandomXGBoostJSONs_1Tree_VariableBatchSize<FPType>(
        args, 4, 4, tileShapeBitWidth)));
  }
  {
    using FPType = float;
    Test_ASSERT((Test_RandomXGBoostJSONs_1Tree_VariableBatchSize<FPType>(
...
bool Test_UniformTiling_RandomXGBoostJSONs_2Trees_BatchSize4(TestArgs_t &args) {
  {
    using FPType = double;
    Test_ASSERT(
        (Test_RandomXGBoostJSONs_2Trees_VariableBatchSize<FPType>(args, 4, 2)));
    Test_ASSERT(
        (Test_RandomXGBoostJSONs_2Trees_VariableBatchSize<FPType>(args, 4, 3)));
    Test_ASSERT(
        (Test_RandomXGBoostJSONs_2Trees_VariableBatchSize<FPType>(args, 4, 4)));
  }
  {
    using FPType = float;
    Test_ASSERT(
...
bool Test_UniformTiling_RandomXGBoostJSONs_2Trees_BatchSize4_Int8TileShape(
  ...
  {
    using FPType = double;
    Test_ASSERT((Test_RandomXGBoostJSONs_2Trees_VariableBatchSize<FPType>(
        args, 4, 2, tileShapeBitwidth)));
    Test_ASSERT((Test_RandomXGBoostJSONs_2Trees_VariableBatchSize<FPType>(
        args, 4, 3, tileShapeBitwidth)));
    Test_ASSERT((Test_RandomXGBoostJSONs_2Trees_VariableBatchSize<FPType>(
...
bool Test_UniformTiling_RandomXGBoostJSONs_4Trees_BatchSize4(TestArgs_t &args) {
  {
    using FPType = double;
    Test_ASSERT(
        (Test_RandomXGBoostJSONs_4Trees_VariableBatchSize<FPType>(args, 4, 2)));
    Test_ASSERT(
        (Test_RandomXGBoostJSONs_4Trees_VariableBatchSize<FPType>(args, 4, 3)));
    Test_ASSERT(
        (Test_RandomXGBoostJSONs_4Trees_VariableBatchSize<FPType>(args, 4, 4)));
  }
  {
    using FPType = float;
    Test_ASSERT(
...
bool Test_UniformTiling_RandomXGBoostJSONs_4Trees_BatchSize4_Int8TileShape(
  ...
  {
    using FPType = double;
    Test_ASSERT((Test_RandomXGBoostJSONs_4Trees_VariableBatchSize<FPType>(
        args, 4, 2, tileShapeBitWidth)));
    Test_ASSERT((Test_RandomXGBoostJSONs_4Trees_VariableBatchSize<FPType>(
        args, 4, 3, tileShapeBitWidth)));
    Test_ASSERT((Test_RandomXGBoostJSONs_4Trees_VariableBatchSize<FPType>(
...
bool Test_SingleTileSize_SingleModel(
    TestArgs_t &args, const std::string &modelJSONPath, int32_t tileSize,
    bool skipInt8 = false, int32_t tileShapeBitWidth = 32,
    int32_t childIndexBitWidth = 1, std::string csvPath = "",
    ScheduleManipulator_t scheduleManipulator = nullptr,
    bool makeAllLeavesSameDepth = false, bool reorderTrees = false,
    int32_t pipelineSize = -1) {
  if (csvPath == "")
    csvPath = modelJSONPath + ".csv";
  {
    using FPType = double;
    if (!RunSingleBatchSizeForXGBoostTests) {
      Test_ASSERT(Test_CodeGenForJSON_VariableBatchSize<FPType>(
          args, 1, modelJSONPath, csvPath, tileSize, tileShapeBitWidth,
          childIndexBitWidth, makeAllLeavesSameDepth, reorderTrees,
          scheduleManipulator, pipelineSize));
      Test_ASSERT(Test_CodeGenForJSON_VariableBatchSize<FPType>(
          args, 2, modelJSONPath, csvPath, tileSize, tileShapeBitWidth,
          childIndexBitWidth, makeAllLeavesSameDepth, reorderTrees,
          scheduleManipulator, pipelineSize));
    }
    Test_ASSERT(Test_CodeGenForJSON_VariableBatchSize<FPType>(
        args, 4, modelJSONPath, csvPath, tileSize, tileShapeBitWidth,
        childIndexBitWidth, makeAllLeavesSameDepth, reorderTrees,
        scheduleManipulator, pipelineSize));
  }
  {
    ...
    if (!RunSingleBatchSizeForXGBoostTests) {
      Test_ASSERT((Test_CodeGenForJSON_VariableBatchSize<FPType, IntType>(
          args, 1, modelJSONPath, csvPath, tileSize, tileShapeBitWidth,
          childIndexBitWidth, makeAllLeavesSameDepth, reorderTrees,
          scheduleManipulator, pipelineSize)));
      Test_ASSERT((Test_CodeGenForJSON_VariableBatchSize<FPType, IntType>(
...
bool Test_SingleTileSize_SingleModel_FloatOnly(
    TestArgs_t &args, const std::string &modelJSONPath, int32_t tileSize,
    bool skipInt8 = false, int32_t tileShapeBitWidth = 32,
    int32_t childIndexBitWidth = 1, std::string csvPath = "",
    ScheduleManipulator_t scheduleManipulator = nullptr,
...
bool Test_MultiClass_Int32ReturnType(
    TestArgs_t &args, const std::string &modelJSONPath, int32_t tileSize,
    bool skipInt8 = false, int32_t tileShapeBitWidth = 32,
    int32_t childIndexBitWidth = 1, std::string csvPath = "",
    ScheduleManipulator_t scheduleManipulator = nullptr,
  ...
  Test_ASSERT((Test_CodeGenForJSON_VariableBatchSize<float, int32_t, int8_t>(
      args, 8, modelJSONPath, csvPath, tileSize, tileShapeBitWidth,
      childIndexBitWidth, makeAllLeavesSameDepth, reorderTrees,
      scheduleManipulator, pipelineSize)));
  return true;
}
...
static bool Test_TileSizeVariable_CovType_Int8Type(TestArgs_t &args,
                                                   int32_t tileSize) {
  auto repoPath = GetTreeBeardRepoPath();
  auto testModelsDir = repoPath + "/xgb_models";
  auto modelJSONPath = testModelsDir + "/covtype_xgb_model_save.json";
  auto csvPath = modelJSONPath + ".csv";
  return Test_MultiClass_Int32ReturnType(args, modelJSONPath, tileSize, false,
                                         16, 16, csvPath);
}
...
static bool Test_TileSizeVariable_Letters_Int8Type(TestArgs_t &args,
                                                   int32_t tileSize) {
  auto repoPath = GetTreeBeardRepoPath();
  auto testModelsDir = repoPath + "/xgb_models";
...
static bool Test_TileSizeVariable_Letters_Pipelined_Int8Type(
    TestArgs_t &args, int32_t tileSize, int32_t pipelineSize) {
  auto repoPath = GetTreeBeardRepoPath();
  auto testModelsDir = repoPath + "/xgb_models";
  auto modelJSONPath = testModelsDir + "/letters_xgb_model_save.json";
  auto csvPath = modelJSONPath + ".test.sampled.csv";
  return Test_MultiClass_Int32ReturnType(args, modelJSONPath, tileSize, false,
                                         16, 16, csvPath, nullptr, true, true,
                                         pipelineSize);
}
...
bool Test_Scalar_Abalone_OneTreeAtATimeSchedule(TestArgs_t &args) {
  ...
  auto modelJSONPath = testModelsDir + "/abalone_xgb_model_save.json";
  int32_t tileSize = 1;
  return Test_SingleTileSize_SingleModel(args, modelJSONPath, tileSize, false,
                                         32, 1, "", OneTreeAtATimeSchedule);
}
...
void pipelineTreeLoop(Schedule *schedule) {
  auto &treeIndex = schedule->GetTreeIndex();
  schedule->Pipeline(treeIndex, 4);
}
...
bool Test_TileSize8_Abalone_4PipelinedTrees_TestInputs(TestArgs_t &args) {
  ...
  int32_t tileSize = 8;
  return Test_SingleTileSize_SingleModel_FloatOnly(
      args, modelJSONPath, tileSize, false, 16, 16, csvPath, pipelineTreeLoop,
      true, false, -1);
}
...
bool Test_TileSize8_AirlineOHE_TestInputs(TestArgs_t &args) {
  ...
  int32_t tileSize = 8;
  return Test_SingleTileSize_SingleModel_FloatOnly(
      args, modelJSONPath, tileSize, true, 16, 16, csvPath);
}
...
bool Test_SparseTileSize8_AirlineOHE_TestInputs_TiledSchedule(
    TestArgs_t &args) {
  decisionforest::UseSparseTreeRepresentation = true;
  auto repoPath = GetTreeBeardRepoPath();
  auto testModelsDir = repoPath + "/xgb_models";
...
bool Test_SparseTileSize8_Letters_TiledSchedule(TestArgs_t &args) {
  ...
  auto csvPath = modelJSONPath + ".test.sampled.csv";
  return Test_MultiClass_Int32ReturnType(args, modelJSONPath, tileSize, false,
                                         16, 16, csvPath, TiledSchedule<2, 4>);
}
...
bool Test_CodeGenForJSON_VariableBatchSize(
  ...
  TreeBeard::CompilerOptions options(
      ...
      sizeof(FeatureIndexType) * 8, sizeof(NodeIndexType) * 8,
      floatTypeBitWidth, batchSize, tileSize, tileShapeBitWidth,
      childIndexBitWidth, TreeBeard::TilingType::kHybrid, false, false,
      scheduleManipulatorFunc ? &scheduleManipulator : nullptr);
  ...
  TreeBeard::TreebeardContext tbContext(
      ...
      nullptr /*TODO_ForestCreator*/);
  auto module = TreeBeard::ConstructLLVMDialectModuleFromXGBoostJSON<
      FloatType, ResultType, FeatureIndexType, int32_t, FloatType>(tbContext);
  ...
  for (auto &batch : inputData) {
    ...
    for (int64_t rowIdx = 0; rowIdx < batchSize; ++rowIdx) {
      ...
      // FloatType forestPrediction =
      // xgBoostParser.GetForest()->Predict_Float(row);
      ...
      // std::cout << forestPrediction << "\t" << result[rowIdx] << "\t" <<
...
bool Test_SingleTileSize_SingleModel_FloatOnly(
    TestArgs_t &args, const std::string &modelJSONPath,
    const std::string &statsProfileCSV, int32_t tileSize, bool skipInt8 = false,
    int32_t tileShapeBitWidth = 32, int32_t childIndexBitWidth = 1,
    std::string csvPath = "",
    ScheduleManipulator_t scheduleManipulator = nullptr) {
  if (csvPath == "")
    csvPath = modelJSONPath + ".csv";
  {
    using FPType = float;
    Test_ASSERT((Test_CodeGenForJSON_VariableBatchSize<FPType>(
        args, 4, modelJSONPath, csvPath, statsProfileCSV, tileSize,
...
bool Test_SingleTileSize_SingleModel_FloatOnly_Int8ReturnType(
    TestArgs_t &args, const std::string &modelJSONPath,
    const std::string &statsProfileCSV, int32_t tileSize, bool skipInt8 = false,
    int32_t tileShapeBitWidth = 32, int32_t childIndexBitWidth = 1,
    std::string csvPath = "",
  ...
  {
    using FPType = float;
    Test_ASSERT((Test_CodeGenForJSON_VariableBatchSize<FPType, int32_t, int8_t>(
        args, 4, modelJSONPath, csvPath, statsProfileCSV, tileSize,
        tileShapeBitWidth, childIndexBitWidth, scheduleManipulator)));
  }
  {
    using FPType = float;
    using IntType = int16_t;
    Test_ASSERT((Test_CodeGenForJSON_VariableBatchSize<FPType, IntType, int8_t>(
        args, 4, modelJSONPath, csvPath, statsProfileCSV, tileSize,
        tileShapeBitWidth, childIndexBitWidth, scheduleManipulator)));
  }
  if (!skipInt8) {
...
bool Test_ProbabilisticTiling_TileSize8_Abalone(TestArgs_t &args) {
  ...
  int32_t tileSize = 8;
  return Test_SingleTileSize_SingleModel_FloatOnly(
      args, modelJSONPath, statsProfileCSV, tileSize, false, 16, 16);
}
...
bool Test_ProbabilisticTiling_TileSize8_AirlineOHE(TestArgs_t &args) {
  ...
  int32_t tileSize = 8;
  return Test_SingleTileSize_SingleModel_FloatOnly(
      args, modelJSONPath, statsProfileCSV, tileSize, true, 16, 16);
}
...
bool Test_ProbabilisticTiling_TileSize8_Covtype(TestArgs_t &args) {
  ...
  int32_t tileSize = 8;
  return Test_SingleTileSize_SingleModel_FloatOnly_Int8ReturnType(
      args, modelJSONPath, statsProfileCSV, tileSize, false, 16, 16);
}
...
bool Test_RandomXGBoostJSONs_1Tree_BatchSize4_EqualDepth_TileSize8(
    TestArgs_t &args) {
  return Test_RandomXGBoostJSONs_1Tree_VariableBatchSize(args, 4, 8, 16, 1,
                                                         true);
}

bool Test_RandomXGBoostJSONs_2Trees_BatchSize4_EqualDepth_TileSize8(
    TestArgs_t &args) {
  return Test_RandomXGBoostJSONs_2Trees_VariableBatchSize(args, 4, 8, 16, 1,
                                                          true);
}

bool Test_RandomXGBoostJSONs_4Trees_BatchSize4_EqualDepth_TileSize8(
    TestArgs_t &args) {
  return Test_RandomXGBoostJSONs_4Trees_VariableBatchSize(args, 4, 8, 16, 1,
                                                          true);
}
...
bool Test_TileSize8_AirlineOHE_TestInputs_MakeLeavesSameDepth(
    TestArgs_t &args) {
  auto repoPath = GetTreeBeardRepoPath();
  auto testModelsDir = repoPath + "/xgb_models";
  auto modelJSONPath = testModelsDir + "/airline-ohe_xgb_model_save.json";
  ...
  int32_t tileSize = 8;
  return Test_SingleTileSize_SingleModel_FloatOnly(
      args, modelJSONPath, tileSize, true, 16, 16, csvPath, nullptr, true);
}
...
bool Test_TileSize8_Abalone_TestInputs_SplitTreeLoopSchedule(TestArgs_t &args) {
  ...
  return Test_SingleTileSize_SingleModel_FloatOnly(
      args, modelJSONPath, tileSize, false, 16, 16, csvPath,
      SplitTreeDimensionSchedule<500>);
}
...
bool Test_TileSize8_Abalone_TestInputs_SwapAndSplitTreeIndex(TestArgs_t &args) {
  ...
  return Test_SingleTileSize_SingleModel_FloatOnly(
      args, modelJSONPath, tileSize, false, 16, 16, csvPath,
      SwapAndSplitTreeDimensionSchedule<500>);
}
...
bool Test_TileSize8_Airline_TestInputs_SwapAndSplitTreeIndex(TestArgs_t &args) {
  ...
  return Test_SingleTileSize_SingleModel_FloatOnly(
      args, modelJSONPath, tileSize, false, 16, 16, csvPath,
      SwapAndSplitTreeDimensionSchedule<50>);
}
...
// ===--------------------------------------------------------=== //
// XGBoost Test Inputs Parallel Tree Schedule (4 sets of trees)
// ===--------------------------------------------------------=== //
// Defined in Reduction.cpp
void tileAndParallelizeTrees(decisionforest::Schedule &schedule,
                             int32_t numSubBatches);

void tileAndParallelizeTreesWrapper(decisionforest::Schedule *schedule) {
  tileAndParallelizeTrees(*schedule, 4);
}
...
bool Test_SparseTileSize8_Abalone_TestInputs_4ParallelTreeSets(
  ...
  Test_ASSERT((Test_CodeGenForJSON_VariableBatchSize<float, int8_t>(
      args, 200, modelJSONPath, csvPath, tileSize, tileShapeBitWidth,
      childIndexBitWidth, false, false, tileAndParallelizeTreesWrapper)));
  return true;
}
