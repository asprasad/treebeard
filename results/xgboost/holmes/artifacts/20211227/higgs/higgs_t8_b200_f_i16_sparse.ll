...
@model = private global [9091 x { <8 x float>, <8 x i16>, i16, i16 }] undef
@offsets = private global [100 x i64] undef
@lengths = private global [100 x i64] undef
@leaves = private global [68607 x float] undef
...
50:                                               ; preds = %46
  ...
  %55 = mul i64 %52, 1
  %56 = add i64 0, %55
  %57 = insertvalue { { <8 x float>, <8 x i16>, i16, i16 }*, { <8 x float>, <8 x i16>, i16, i16 }*, i64, [1 x i64], [1 x i64] } { { <8 x float>, <8 x i16>, i16, i16 }* inttoptr (i64 3735928559 to { <8 x float>, <8 x i16>, i16, i16 }*), { <8 x float>, <8 x i16>, i16, i16 }* getelementptr inbounds ([9091 x { <8 x float>, <8 x i16>, i16, i16 }], [9091 x { <8 x float>, <8 x i16>, i16, i16 }]* @model, i64 0, i64 0), i64 undef, [1 x i64] undef, [1 x i64] undef }, i64 %56, 2
  ...
  %64 = mul i64 %61, 1
  %65 = add i64 0, %64
  %66 = insertvalue { float*, float*, i64, [1 x i64], [1 x i64] } { float* inttoptr (i64 3735928559 to float*), float* getelementptr inbounds ([68607 x float], [68607 x float]* @leaves, i64 0, i64 0), i64 undef, [1 x i64] undef, [1 x i64] undef }, i64 %65, 2
...
73:                                               ; preds = %69
  %74 = add i64 %56, %70
  %75 = getelementptr { <8 x float>, <8 x i16>, i16, i16 }, { <8 x float>, <8 x i16>, i16, i16 }* getelementptr inbounds ([9091 x { <8 x float>, <8 x i16>, i16, i16 }], [9091 x { <8 x float>, <8 x i16>, i16, i16 }]* @model, i64 0, i64 0), i64 %74, i32 1
...
83:                                               ; preds = %81
  %84 = phi i64 [ %70, %81 ]
  %85 = add i64 %56, %84
  %86 = getelementptr { <8 x float>, <8 x i16>, i16, i16 }, { <8 x float>, <8 x i16>, i16, i16 }* getelementptr inbounds ([9091 x { <8 x float>, <8 x i16>, i16, i16 }], [9091 x { <8 x float>, <8 x i16>, i16, i16 }]* @model, i64 0, i64 0), i64 %85, i32 0
  %87 = load <8 x float>, <8 x float>* %86, align 32
  %88 = add i64 %56, %84
  %89 = getelementptr { <8 x float>, <8 x i16>, i16, i16 }, { <8 x float>, <8 x i16>, i16, i16 }* getelementptr inbounds ([9091 x { <8 x float>, <8 x i16>, i16, i16 }], [9091 x { <8 x float>, <8 x i16>, i16, i16 }]* @model, i64 0, i64 0), i64 %88, i32 1
  %90 = load <8 x i16>, <8 x i16>* %89, align 16
  %91 = add i64 %56, %84
  %92 = getelementptr { <8 x float>, <8 x i16>, i16, i16 }, { <8 x float>, <8 x i16>, i16, i16 }* getelementptr inbounds ([9091 x { <8 x float>, <8 x i16>, i16, i16 }], [9091 x { <8 x float>, <8 x i16>, i16, i16 }]* @model, i64 0, i64 0), i64 %91, i32 2
  %93 = load i16, i16* %92, align 2
  %94 = sext i16 %93 to i64
  %95 = add i64 %56, %84
  %96 = getelementptr { <8 x float>, <8 x i16>, i16, i16 }, { <8 x float>, <8 x i16>, i16, i16 }* getelementptr inbounds ([9091 x { <8 x float>, <8 x i16>, i16, i16 }], [9091 x { <8 x float>, <8 x i16>, i16, i16 }]* @model, i64 0, i64 0), i64 %95, i32 3
...
117:                                              ; preds = %115
  %118 = add i64 %56, %70
  %119 = getelementptr { <8 x float>, <8 x i16>, i16, i16 }, { <8 x float>, <8 x i16>, i16, i16 }* getelementptr inbounds ([9091 x { <8 x float>, <8 x i16>, i16, i16 }], [9091 x { <8 x float>, <8 x i16>, i16, i16 }]* @model, i64 0, i64 0), i64 %118, i32 0
...
122:                                              ; preds = %115
  %123 = sub i64 %70, %54
  %124 = add i64 %65, %123
  %125 = getelementptr float, float* getelementptr inbounds ([68607 x float], [68607 x float]* @leaves, i64 0, i64 0), i64 %124
...
define { { <8 x float>, <8 x i16>, i16, i16 }*, { <8 x float>, <8 x i16>, i16, i16 }*, i64, [1 x i64], [1 x i64] } @Get_model() {
  ret { { <8 x float>, <8 x i16>, i16, i16 }*, { <8 x float>, <8 x i16>, i16, i16 }*, i64, [1 x i64], [1 x i64] } { { <8 x float>, <8 x i16>, i16, i16 }* inttoptr (i64 3735928559 to { <8 x float>, <8 x i16>, i16, i16 }*), { <8 x float>, <8 x i16>, i16, i16 }* getelementptr inbounds ([9091 x { <8 x float>, <8 x i16>, i16, i16 }], [9091 x { <8 x float>, <8 x i16>, i16, i16 }]* @model, i64 0, i64 0), i64 0, [1 x i64] [i64 9091], [1 x i64] [i64 1] }
}
...
define { float*, float*, i64, [1 x i64], [1 x i64] } @Get_leaves() {
  ret { float*, float*, i64, [1 x i64], [1 x i64] } { float* inttoptr (i64 3735928559 to float*), float* getelementptr inbounds ([68607 x float], [68607 x float]* @leaves, i64 0, i64 0), i64 0, [1 x i64] [i64 68607], [1 x i64] [i64 1] }
}
...
44:                                               ; preds = %41
  ...
  %105 = add i64 0, %42
  %106 = getelementptr { <8 x float>, <8 x i16>, i16, i16 }, { <8 x float>, <8 x i16>, i16, i16 }* getelementptr inbounds ([9091 x { <8 x float>, <8 x i16>, i16, i16 }], [9091 x { <8 x float>, <8 x i16>, i16, i16 }]* @model, i64 0, i64 0), i64 %105, i32 0
  store <8 x float> %97, <8 x float>* %106, align 32
  %107 = add i64 0, %42
  %108 = getelementptr { <8 x float>, <8 x i16>, i16, i16 }, { <8 x float>, <8 x i16>, i16, i16 }* getelementptr inbounds ([9091 x { <8 x float>, <8 x i16>, i16, i16 }], [9091 x { <8 x float>, <8 x i16>, i16, i16 }]* @model, i64 0, i64 0), i64 %107, i32 1
  store <8 x i16> %100, <8 x i16>* %108, align 16
  %109 = add i64 0, %42
  %110 = getelementptr { <8 x float>, <8 x i16>, i16, i16 }, { <8 x float>, <8 x i16>, i16, i16 }* getelementptr inbounds ([9091 x { <8 x float>, <8 x i16>, i16, i16 }], [9091 x { <8 x float>, <8 x i16>, i16, i16 }]* @model, i64 0, i64 0), i64 %109, i32 2
  store i16 %102, i16* %110, align 2
  %111 = add i64 0, %42
  %112 = getelementptr { <8 x float>, <8 x i16>, i16, i16 }, { <8 x float>, <8 x i16>, i16, i16 }* getelementptr inbounds ([9091 x { <8 x float>, <8 x i16>, i16, i16 }], [9091 x { <8 x float>, <8 x i16>, i16, i16 }]* @model, i64 0, i64 0), i64 %111, i32 3
  store i16 %104, i16* %112, align 2
  %113 = add i64 %42, 1
  br label %41

114:                                              ; preds = %41
  ret i32 trunc (i64 sub (i64 ptrtoint ({ <8 x float>, <8 x i16>, i16, i16 }* getelementptr ({ <8 x float>, <8 x i16>, i16, i16 }, { <8 x float>, <8 x i16>, i16, i16 }* getelementptr inbounds ([9091 x { <8 x float>, <8 x i16>, i16, i16 }], [9091 x { <8 x float>, <8 x i16>, i16, i16 }]* @model, i64 0, i64 0), i64 9091) to i64), i64 ptrtoint ([9091 x { <8 x float>, <8 x i16>, i16, i16 }]* @model to i64)) to i32)
}
