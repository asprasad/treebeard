...
46:                                               ; preds = %98, %35
  ...
  %48 = phi float [ 5.000000e-01, %35 ], [ %103, %98 ]
...
50:                                               ; preds = %46
  ...
  %55 = mul i64 %52, 1
  %56 = add i64 0, %55
  %57 = insertvalue { { <8 x float>, <8 x i16>, i16 }*, { <8 x float>, <8 x i16>, i16 }*, i64, [1 x i64], [1 x i64] } { { <8 x float>, <8 x i16>, i16 }* inttoptr (i64 3735928559 to { <8 x float>, <8 x i16>, i16 }*), { <8 x float>, <8 x i16>, i16 }* getelementptr inbounds ([91000 x { <8 x float>, <8 x i16>, i16 }], [91000 x { <8 x float>, <8 x i16>, i16 }]* @model, i64 0, i64 0), i64 undef, [1 x i64] undef, [1 x i64] undef }, i64 %56, 2
...
60:                                               ; preds = %68, %50
  ...
  %62 = add i64 %56, %61
  %63 = getelementptr { <8 x float>, <8 x i16>, i16 }, { <8 x float>, <8 x i16>, i16 }* getelementptr inbounds ([91000 x { <8 x float>, <8 x i16>, i16 }], [91000 x { <8 x float>, <8 x i16>, i16 }]* @model, i64 0, i64 0), i64 %62, i32 1
...
68:                                               ; preds = %60
  %69 = phi i64 [ %61, %60 ]
  %70 = add i64 %56, %69
  %71 = getelementptr { <8 x float>, <8 x i16>, i16 }, { <8 x float>, <8 x i16>, i16 }* getelementptr inbounds ([91000 x { <8 x float>, <8 x i16>, i16 }], [91000 x { <8 x float>, <8 x i16>, i16 }]* @model, i64 0, i64 0), i64 %70, i32 0
  %72 = load <8 x float>, <8 x float>* %71, align 32
  %73 = add i64 %56, %69
  %74 = getelementptr { <8 x float>, <8 x i16>, i16 }, { <8 x float>, <8 x i16>, i16 }* getelementptr inbounds ([91000 x { <8 x float>, <8 x i16>, i16 }], [91000 x { <8 x float>, <8 x i16>, i16 }]* @model, i64 0, i64 0), i64 %73, i32 1
  %75 = load <8 x i16>, <8 x i16>* %74, align 16
  %76 = add i64 %56, %69
  %77 = getelementptr { <8 x float>, <8 x i16>, i16 }, { <8 x float>, <8 x i16>, i16 }* getelementptr inbounds ([91000 x { <8 x float>, <8 x i16>, i16 }], [91000 x { <8 x float>, <8 x i16>, i16 }]* @model, i64 0, i64 0), i64 %76, i32 2
...
98:                                               ; preds = %60
  %99 = add i64 %56, %61
  %100 = getelementptr { <8 x float>, <8 x i16>, i16 }, { <8 x float>, <8 x i16>, i16 }* getelementptr inbounds ([91000 x { <8 x float>, <8 x i16>, i16 }], [91000 x { <8 x float>, <8 x i16>, i16 }]* @model, i64 0, i64 0), i64 %99, i32 0
...
105:                                              ; preds = %46
  %106 = getelementptr float, float* %8, i64 %33
  store float %48, float* %106, align 4
  %107 = add i64 %33, 1
  br label %32
