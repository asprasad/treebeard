...
@leaves = private global [69111 x float] undef
...
35:                                               ; preds = %32
  ...
  %42 = insertvalue { float*, float*, i64, [2 x i64], [2 x i64] } %41, i64 13, 3, 1
  %43 = insertvalue { float*, float*, i64, [2 x i64], [2 x i64] } %42, i64 1, 4, 1
  %44 = insertvalue { float*, float*, i64, [2 x i64], [2 x i64] } %43, i64 1, 3, 0
  %45 = insertvalue { float*, float*, i64, [2 x i64], [2 x i64] } %44, i64 13, 4, 0
  br label %46
...
50:                                               ; preds = %46
  ...
  %64 = mul i64 %61, 1
  %65 = add i64 0, %64
  %66 = insertvalue { float*, float*, i64, [1 x i64], [1 x i64] } { float* inttoptr (i64 3735928559 to float*), float* getelementptr inbounds ([69111 x float], [69111 x float]* @leaves, i64 0, i64 0), i64 undef, [1 x i64] undef, [1 x i64] undef }, i64 %65, 2
...
122:                                              ; preds = %115
  %123 = sub i64 %70, %54
  %124 = add i64 %65, %123
  %125 = getelementptr float, float* getelementptr inbounds ([69111 x float], [69111 x float]* @leaves, i64 0, i64 0), i64 %124
...
define { float*, float*, i64, [1 x i64], [1 x i64] } @Get_leaves() {
  ret { float*, float*, i64, [1 x i64], [1 x i64] } { float* inttoptr (i64 3735928559 to float*), float* getelementptr inbounds ([69111 x float], [69111 x float]* @leaves, i64 0, i64 0), i64 0, [1 x i64] [i64 69111], [1 x i64] [i64 1] }
}
