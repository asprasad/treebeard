...
@model = private global [80542 x { <8 x float>, <8 x i16>, i16 }] undef
...
50:                                               ; preds = %46
  ...
  %55 = mul i64 %52, 1
  %56 = add i64 0, %55
  %57 = insertvalue { { <8 x float>, <8 x i16>, i16 }*, { <8 x float>, <8 x i16>, i16 }*, i64, [1 x i64], [1 x i64] } { { <8 x float>, <8 x i16>, i16 }* inttoptr (i64 3735928559 to { <8 x float>, <8 x i16>, i16 }*), { <8 x float>, <8 x i16>, i16 }* getelementptr inbounds ([80542 x { <8 x float>, <8 x i16>, i16 }], [80542 x { <8 x float>, <8 x i16>, i16 }]* @model, i64 0, i64 0), i64 undef, [1 x i64] undef, [1 x i64] undef }, i64 %56, 2
...
60:                                               ; preds = %68, %50
  ...
  %62 = add i64 %56, %61
  %63 = getelementptr { <8 x float>, <8 x i16>, i16 }, { <8 x float>, <8 x i16>, i16 }* getelementptr inbounds ([80542 x { <8 x float>, <8 x i16>, i16 }], [80542 x { <8 x float>, <8 x i16>, i16 }]* @model, i64 0, i64 0), i64 %62, i32 1
...
68:                                               ; preds = %60
  %69 = phi i64 [ %61, %60 ]
  %70 = add i64 %56, %69
  %71 = getelementptr { <8 x float>, <8 x i16>, i16 }, { <8 x float>, <8 x i16>, i16 }* getelementptr inbounds ([80542 x { <8 x float>, <8 x i16>, i16 }], [80542 x { <8 x float>, <8 x i16>, i16 }]* @model, i64 0, i64 0), i64 %70, i32 0
  %72 = load <8 x float>, <8 x float>* %71, align 32
  %73 = add i64 %56, %69
  %74 = getelementptr { <8 x float>, <8 x i16>, i16 }, { <8 x float>, <8 x i16>, i16 }* getelementptr inbounds ([80542 x { <8 x float>, <8 x i16>, i16 }], [80542 x { <8 x float>, <8 x i16>, i16 }]* @model, i64 0, i64 0), i64 %73, i32 1
  %75 = load <8 x i16>, <8 x i16>* %74, align 16
  %76 = add i64 %56, %69
  %77 = getelementptr { <8 x float>, <8 x i16>, i16 }, { <8 x float>, <8 x i16>, i16 }* getelementptr inbounds ([80542 x { <8 x float>, <8 x i16>, i16 }], [80542 x { <8 x float>, <8 x i16>, i16 }]* @model, i64 0, i64 0), i64 %76, i32 2
...
98:                                               ; preds = %60
  %99 = add i64 %56, %61
  %100 = getelementptr { <8 x float>, <8 x i16>, i16 }, { <8 x float>, <8 x i16>, i16 }* getelementptr inbounds ([80542 x { <8 x float>, <8 x i16>, i16 }], [80542 x { <8 x float>, <8 x i16>, i16 }]* @model, i64 0, i64 0), i64 %99, i32 0
...
define { { <8 x float>, <8 x i16>, i16 }*, { <8 x float>, <8 x i16>, i16 }*, i64, [1 x i64], [1 x i64] } @Get_model() {
  ret { { <8 x float>, <8 x i16>, i16 }*, { <8 x float>, <8 x i16>, i16 }*, i64, [1 x i64], [1 x i64] } { { <8 x float>, <8 x i16>, i16 }* inttoptr (i64 3735928559 to { <8 x float>, <8 x i16>, i16 }*), { <8 x float>, <8 x i16>, i16 }* getelementptr inbounds ([80542 x { <8 x float>, <8 x i16>, i16 }], [80542 x { <8 x float>, <8 x i16>, i16 }]* @model, i64 0, i64 0), i64 0, [1 x i64] [i64 80542], [1 x i64] [i64 1] }
}
...
34:                                               ; preds = %31
  ...
  %93 = add i64 0, %32
  %94 = getelementptr { <8 x float>, <8 x i16>, i16 }, { <8 x float>, <8 x i16>, i16 }* getelementptr inbounds ([80542 x { <8 x float>, <8 x i16>, i16 }], [80542 x { <8 x float>, <8 x i16>, i16 }]* @model, i64 0, i64 0), i64 %93, i32 0
  store <8 x float> %87, <8 x float>* %94, align 32
  %95 = add i64 0, %32
  %96 = getelementptr { <8 x float>, <8 x i16>, i16 }, { <8 x float>, <8 x i16>, i16 }* getelementptr inbounds ([80542 x { <8 x float>, <8 x i16>, i16 }], [80542 x { <8 x float>, <8 x i16>, i16 }]* @model, i64 0, i64 0), i64 %95, i32 1
  store <8 x i16> %90, <8 x i16>* %96, align 16
  %97 = add i64 0, %32
  %98 = getelementptr { <8 x float>, <8 x i16>, i16 }, { <8 x float>, <8 x i16>, i16 }* getelementptr inbounds ([80542 x { <8 x float>, <8 x i16>, i16 }], [80542 x { <8 x float>, <8 x i16>, i16 }]* @model, i64 0, i64 0), i64 %97, i32 2
  store i16 %92, i16* %98, align 2
  %99 = add i64 %32, 1
  br label %31

100:                                              ; preds = %31
  ret i32 trunc (i64 sub (i64 ptrtoint ({ <8 x float>, <8 x i16>, i16 }* getelementptr ({ <8 x float>, <8 x i16>, i16 }, { <8 x float>, <8 x i16>, i16 }* getelementptr inbounds ([80542 x { <8 x float>, <8 x i16>, i16 }], [80542 x { <8 x float>, <8 x i16>, i16 }]* @model, i64 0, i64 0), i64 80542) to i64), i64 ptrtoint ([80542 x { <8 x float>, <8 x i16>, i16 }]* @model to i64)) to i32)
}
