...
46:                                               ; preds = %43
  ...
  %53 = insertvalue { float*, float*, i64, [2 x i64], [2 x i64] } %52, i64 13, 3, 1
  %54 = insertvalue { float*, float*, i64, [2 x i64], [2 x i64] } %53, i64 1, 4, 1
  %55 = insertvalue { float*, float*, i64, [2 x i64], [2 x i64] } %54, i64 1, 3, 0
  %56 = insertvalue { float*, float*, i64, [2 x i64], [2 x i64] } %55, i64 13, 4, 0
  br label %57
...
61:                                               ; preds = %57
  %62 = add i64 %40, %58
  %63 = getelementptr i64, i64* getelementptr inbounds ([100 x i64], [100 x i64]* @offsets, i64 0, i64 0), i64 %62
  %64 = load i64, i64* %63, align 4
  %65 = getelementptr i64, i64* getelementptr inbounds ([100 x i64], [100 x i64]* @lengths, i64 0, i64 0), i64 %62
  %66 = load i64, i64* %65, align 4
  %67 = mul i64 %64, 1
  %68 = add i64 0, %67
  %69 = insertvalue { { <8 x float>, <8 x i16>, i16 }*, { <8 x float>, <8 x i16>, i16 }*, i64, [1 x i64], [1 x i64] } { { <8 x float>, <8 x i16>, i16 }* inttoptr (i64 3735928559 to { <8 x float>, <8 x i16>, i16 }*), { <8 x float>, <8 x i16>, i16 }* getelementptr inbounds ([82000 x { <8 x float>, <8 x i16>, i16 }], [82000 x { <8 x float>, <8 x i16>, i16 }]* @model, i64 0, i64 0), i64 undef, [1 x i64] undef, [1 x i64] undef }, i64 %68, 2
...
72:                                               ; preds = %80, %61
  ...
  %74 = add i64 %68, %73
  %75 = getelementptr { <8 x float>, <8 x i16>, i16 }, { <8 x float>, <8 x i16>, i16 }* getelementptr inbounds ([82000 x { <8 x float>, <8 x i16>, i16 }], [82000 x { <8 x float>, <8 x i16>, i16 }]* @model, i64 0, i64 0), i64 %74, i32 1
...
80:                                               ; preds = %72
  %81 = phi i64 [ %73, %72 ]
  %82 = add i64 %68, %81
  %83 = getelementptr { <8 x float>, <8 x i16>, i16 }, { <8 x float>, <8 x i16>, i16 }* getelementptr inbounds ([82000 x { <8 x float>, <8 x i16>, i16 }], [82000 x { <8 x float>, <8 x i16>, i16 }]* @model, i64 0, i64 0), i64 %82, i32 0
  %84 = load <8 x float>, <8 x float>* %83, align 32
  %85 = add i64 %68, %81
  %86 = getelementptr { <8 x float>, <8 x i16>, i16 }, { <8 x float>, <8 x i16>, i16 }* getelementptr inbounds ([82000 x { <8 x float>, <8 x i16>, i16 }], [82000 x { <8 x float>, <8 x i16>, i16 }]* @model, i64 0, i64 0), i64 %85, i32 1
  %87 = load <8 x i16>, <8 x i16>* %86, align 16
  %88 = add i64 %68, %81
  %89 = getelementptr { <8 x float>, <8 x i16>, i16 }, { <8 x float>, <8 x i16>, i16 }* getelementptr inbounds ([82000 x { <8 x float>, <8 x i16>, i16 }], [82000 x { <8 x float>, <8 x i16>, i16 }]* @model, i64 0, i64 0), i64 %88, i32 2
...
110:                                              ; preds = %72
  %111 = add i64 %68, %73
  %112 = getelementptr { <8 x float>, <8 x i16>, i16 }, { <8 x float>, <8 x i16>, i16 }* getelementptr inbounds ([82000 x { <8 x float>, <8 x i16>, i16 }], [82000 x { <8 x float>, <8 x i16>, i16 }]* @model, i64 0, i64 0), i64 %111, i32 0
...
126:                                              ; preds = %129, %125
  %127 = phi i64 [ 0, %125 ], [ %137, %129 ]
  %128 = icmp slt i64 %127, 200
  br i1 %128, label %129, label %138

129:                                              ; preds = %126
  %130 = getelementptr float, float* %8, i64 %127
  %131 = load float, float* %130, align 4
  %132 = fneg float %131
  %133 = call float @llvm.exp.f32(float %132)
  %134 = fadd float 1.000000e+00, %133
  %135 = fdiv float 1.000000e+00, %134
  %136 = getelementptr float, float* %8, i64 %127
