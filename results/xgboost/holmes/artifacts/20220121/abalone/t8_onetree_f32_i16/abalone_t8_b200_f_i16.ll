...
42:                                               ; preds = %39
  %43 = getelementptr i64, i64* getelementptr inbounds ([1000 x i64], [1000 x i64]* @offsets, i64 0, i64 0), i64 %40
  %44 = load i64, i64* %43, align 4
  %45 = getelementptr i64, i64* getelementptr inbounds ([1000 x i64], [1000 x i64]* @lengths, i64 0, i64 0), i64 %40
  %46 = load i64, i64* %45, align 4
  %47 = mul i64 %44, 1
  %48 = add i64 0, %47
  %49 = insertvalue { { <8 x float>, <8 x i16>, i16 }*, { <8 x float>, <8 x i16>, i16 }*, i64, [1 x i64], [1 x i64] } { { <8 x float>, <8 x i16>, i16 }* inttoptr (i64 3735928559 to { <8 x float>, <8 x i16>, i16 }*), { <8 x float>, <8 x i16>, i16 }* getelementptr inbounds ([91000 x { <8 x float>, <8 x i16>, i16 }], [91000 x { <8 x float>, <8 x i16>, i16 }]* @model, i64 0, i64 0), i64 undef, [1 x i64] undef, [1 x i64] undef }, i64 %48, 2
...
55:                                               ; preds = %52
  ...
  %62 = insertvalue { float*, float*, i64, [2 x i64], [2 x i64] } %61, i64 8, 3, 1
  %63 = insertvalue { float*, float*, i64, [2 x i64], [2 x i64] } %62, i64 1, 4, 1
  %64 = insertvalue { float*, float*, i64, [2 x i64], [2 x i64] } %63, i64 1, 3, 0
  %65 = insertvalue { float*, float*, i64, [2 x i64], [2 x i64] } %64, i64 8, 4, 0
  br label %66

66:                                               ; preds = %74, %55
  %67 = phi i64 [ %103, %74 ], [ 0, %55 ]
  %68 = add i64 %48, %67
  %69 = getelementptr { <8 x float>, <8 x i16>, i16 }, { <8 x float>, <8 x i16>, i16 }* getelementptr inbounds ([91000 x { <8 x float>, <8 x i16>, i16 }], [91000 x { <8 x float>, <8 x i16>, i16 }]* @model, i64 0, i64 0), i64 %68, i32 1
...
74:                                               ; preds = %66
  %75 = phi i64 [ %67, %66 ]
  %76 = add i64 %48, %75
  %77 = getelementptr { <8 x float>, <8 x i16>, i16 }, { <8 x float>, <8 x i16>, i16 }* getelementptr inbounds ([91000 x { <8 x float>, <8 x i16>, i16 }], [91000 x { <8 x float>, <8 x i16>, i16 }]* @model, i64 0, i64 0), i64 %76, i32 0
  %78 = load <8 x float>, <8 x float>* %77, align 32
  %79 = add i64 %48, %75
  %80 = getelementptr { <8 x float>, <8 x i16>, i16 }, { <8 x float>, <8 x i16>, i16 }* getelementptr inbounds ([91000 x { <8 x float>, <8 x i16>, i16 }], [91000 x { <8 x float>, <8 x i16>, i16 }]* @model, i64 0, i64 0), i64 %79, i32 1
  %81 = load <8 x i16>, <8 x i16>* %80, align 16
  %82 = add i64 %48, %75
  %83 = getelementptr { <8 x float>, <8 x i16>, i16 }, { <8 x float>, <8 x i16>, i16 }* getelementptr inbounds ([91000 x { <8 x float>, <8 x i16>, i16 }], [91000 x { <8 x float>, <8 x i16>, i16 }]* @model, i64 0, i64 0), i64 %82, i32 2
...
104:                                              ; preds = %66
  %105 = add i64 %48, %67
  %106 = getelementptr { <8 x float>, <8 x i16>, i16 }, { <8 x float>, <8 x i16>, i16 }* getelementptr inbounds ([91000 x { <8 x float>, <8 x i16>, i16 }], [91000 x { <8 x float>, <8 x i16>, i16 }]* @model, i64 0, i64 0), i64 %105, i32 0
