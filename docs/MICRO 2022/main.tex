...
\lstdefinestyle{c++}{language=C++,
    morekeywords={ensemble, getTree, getRoot, isLeaf, isLeafTile, traverseTreeTile, getLeafValue, loadThresholds,
                  ...
                  getChildTile, WalkDecisionTree, moveToChildTile},
...
%%%%%%%%%%%---SETME-----%%%%%%%%%%%%%
\title{Treebeard : An Optimizing Compiler for Decision Tree Based ML Inference}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\author[1]{Ashwin Prasad}
\author[2]{Sampath Rajendra}
\author[2]{Kaushik Rajan}
\author[1]{R Govindarajan}
\author[1]{Uday Bondhugula}
...
% \alignauthor
% Ashwin Prasad\\
%       \affaddr{Indian Institute of Science, Bangalore}
%       \email{ashwinprasad@iisc.ac.in}
% \alignauthor
% Sampath Rajendra\\
%       \affaddr{Microsoft Research}
%        \email{srajendra@microsoft.com}
% \alignauthor
% Kaushik Rajan\\
%       \affaddr{Microsoft Research}
%        \email{krajan@microsoft.com}
% % \and
% \alignauthor
% R Govindarajan\\
%       \affaddr{Indian Institute of Science, Bangalore}
