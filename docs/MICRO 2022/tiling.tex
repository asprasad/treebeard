...
The tiling algorithms generate \op{TileId} attributes per tree and this information is used when lowering to the mid level abstraction in the form of loops. The \op{TileId} attribute maintains a mapping from a Node to the TileId asigned to it. A sample of the lowered MIR code is shown in Figure~\ref{Fig:Overview}.	