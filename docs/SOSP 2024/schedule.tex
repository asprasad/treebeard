...
This section discusses the scheduling language that enables exploration of different strategies for decision tree inference. The language provides an abstract way to specify loop structure and 
...
directives. \TODO{Should we somehow explain what tree and batch loop are?}
