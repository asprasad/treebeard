...
represent XGBoost and Tahoe's strategies. 
...
In the \emph{direct method}, a single GPU thread walks all trees
...
In the \emph{shared data} strategy, a thread block walks all the trees 
