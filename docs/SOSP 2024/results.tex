...
\begin{figure}[htb]
  ...
  heuristic schedule exploration time normalized w.r.t full schedule exploration time \TODO{Change orange line label 
  to ``Heuristic's Normalized Exploration Time''} \TODO{Change other label to say ``Heuristic Schedule vs Best 4060 Schedule''}}
...
\begin{figure}[htb]
  ...
  the heuristic schedule on NVIDIA RTX 4060 across batch sizes\TODO{Change the plot labels to say vs 4060 heuristic schedule}}
