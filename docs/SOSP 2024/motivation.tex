...
Do different schedules and the code generated based on them matter? 
%% RG 
...
%% RG
% Each chart shows the performance of different schedules~-- slowdown compared to the best
% performing schedule~-- as a heatmap. 
The largest slowdown is 5$\times$ 
%% RG
when the best-performing schedule for a model is  
%% schedules are 
used across different batch sizes.  %% and 
It increases to 6$\times$ when schedules are used across different models. 
%% Therefore, no one strategy can be used across all models and batch sizes. 
