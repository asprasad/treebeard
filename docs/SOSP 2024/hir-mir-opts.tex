\section{\Treebeard{} Multi-Level Compiler}
...
significant extensions  (shown as dark boxes in Figure \ref{Fig:CompilerStructure})
were required to support schedule guided compilation for CPUs and GPUs. 
...
\TreebeardOLD{} implements optimizations like 
...
code. The fact that exploting ILP improved performance on GPUs was surprising. 
...
The MIR is then further lowered to a low-level IR (LIR). 
