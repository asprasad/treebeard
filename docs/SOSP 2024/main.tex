...
\lstdefinestyle{c++}{language=C++,
    morekeywords={ensemble, getTree, getRoot, isLeaf, isLeafTile, traverseTreeTile, getLeafValue, loadThresholds,
                  ...
                  reorder, specialize, unrollDepth, unrollWalk, reduce, gpuDimension, cache, reduceDimension, 
                  reduceDimInplace},
...
\title{{\textbf{SilvanForge}}: A Schedule Guided Retargetable Compiler for Decision Tree Inference}
...
% \input{overview.tex}
\input{schedule.tex}
\input{hir-mir-opts.tex}
\input{ir-description.tex}
\input{reduction.tex}
\input{caching.tex}
\input{exploring.tex}
\input{results.tex}
